...
The inspiration I had for initially building my homelab cluster was [this great video series](https://www.youtube.com/watch?v=bx4_QCX_khU&list=PLC53fzn9608B-MT5KvuuHct5MiUDO8IF4) by Patrick Kennedy over at [ServeTheHome](https://www.servethehome.com/). Before laptops became ubiquitous in most organizations, there was a time when "mini PCs" became the preferred choice for employee workstations. These machines have some obvious advantages over traditional full or even mid tower desktops. For one, their smaller size enables things like mounting them behind a monitor via VESA mounting brackets. The smaller size also means they take up less inventory space. Also, probably most importantly, they will generally have much lower power requirements than a full tower PC.
